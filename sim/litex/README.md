...
The memory map is recorded in `config/cislc_o3_platform.json`. It follows the
...
python sim/litex/cislc_o3_axi_sim.py --build --debug-axi
python sim/litex/cislc_o3_axi_sim.py --ram-init program.bin --build --debug-axi
```
